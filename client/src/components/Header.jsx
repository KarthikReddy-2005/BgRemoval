...
const Header = () => {
  ...
  return (
    <div className="flex items center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-15 lg:px-44 sm:mt-20 ">
      {/*left*/}
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          Remove backgrounds from any image instantly with a single click.
          <br className="max-sm:hidden" /> Achieve professional-quality results
          for free, in just one second.
        </p>
        <div>
          <input
